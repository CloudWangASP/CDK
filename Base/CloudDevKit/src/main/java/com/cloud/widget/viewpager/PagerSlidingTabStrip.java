...
package com.cloud.widget.viewpager;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabDefaultTextAppearance = R.style.psts_tab_text_default;
    private int newTabDefaultTextAppearance = R.style.new_psts_tab_text_default;
    private int tabSelectedTextAppearance = R.style.psts_tab_text_default;
    private int indicatorNum = R.style.indicator_num;
    ...
    private TextView titleText, indicatorText;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabSelectedTextAppearance = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsSelectedTextAppearance, tabSelectedTextAppearance);
        tabDefaultTextAppearance = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsDefaultTextAppearance, tabDefaultTextAppearance);
    ...
    public void setViewPager(ViewPager pager, float[] indicatorNum, int screenWidth, boolean hasIndicator, boolean hasNum) {
        this.pager = pager;
    ...
    public void notifyDataSetChanged(float[] indicatorNum, boolean hasIndicator, boolean hasNum) {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTabProvider) {
                ...
                addTextTab(i, pager.getAdapter().getPageTitle(i).toString(), indicatorNum[i], hasIndicator, hasNum, indicatorNum.length);
            }
    ...
    /**
     * Modify by Cloud on 15/12/1.
     * ＊ 更改Tab布局View为ViewGroup
     */
    private void addTextTab(final int position, String title, float num, boolean hasIndicator, boolean hasNum, int tabNum) {
        ...
        if (num != 0 && hasIndicator && !hasNum) {
            ...
            indicatorText.setGravity(Gravity.CENTER);
            indicatorText.setSingleLine();
            indicatorText.setBackgroundDrawable(getContext().getResources().getDrawable(R.drawable.indicator_red_shape));
...
//        addTab(position, tab);
    ...
    private void addTab(final int position, RelativeLayout tab) {
    ...
    public void setTabDefaultTextAppearance(int resId) {
        this.tabDefaultTextAppearance = resId;
    }

    public void setTabSelectedTextAppearance(int resId) {
        this.tabSelectedTextAppearance = resId;
    }
