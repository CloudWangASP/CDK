...
package com.cloud.widget.wheel;
...
import com.cloud.R;
import com.cloud.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private int itemsLayoutGravity = Gravity.LEFT;
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        int height = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, getContext().getResources().getDisplayMetrics());

        centerDrawable.setBounds(0, center + offset - height, getWidth(), center + offset);
    ...
    private void createItemsLayout() {
        if (itemsLayout == null) {
            ...
            itemsLayout.setGravity(itemsLayoutGravity);
        }
    }
    ...
    public View findItemViewByID(int id) {
        if (itemsLayout != null) {
            return itemsLayout.findViewById(id);
        }
